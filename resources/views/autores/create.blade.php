            ...
            <form role="form" action="{{ route('autores.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" value="{{ old('codigo_autor') }}" class="form-control" name="codigo_autor" id="codigo"
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" value="{{ old('nombre_autor') }}" class="form-control" name="nombre_autor" id="nombre"
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" value="{{ old('nacionalidad') }}" class="form-control" id="nacionalidad" name="nacionalidad"
